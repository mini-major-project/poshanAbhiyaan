			...
			try {
				...
				try {
					...
					PreparedStatement pstmtPreg = con.prepareStatement(
							"insert into pregnantPerson(userid, startDateOfPreg,day31Date, day61Date, day91Date, day121Date, day151Date, day181Date, day196Date, day211Date, day226Date, day241Date, day248Date, day255Date, day261Date ) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
